...
pending_topups = {} # پرداخت‌های در حال انتظار
orders = []         # تاریخچه سفارشات
admins = set()      # ادمین‌ها
referrals = {}      # زیرمجموعه‌ها {referrer_id: [user_ids]}
...
📌 پس از پرداخت، رسید را ارسال کنید.""",
        ...
        # ---------- زیرمجموعه گیری ----------
            ...
            await q.edit_message_text(f"🔗 لینک اختصاصی شما:\n{link}\nهر کسی با این لینک وارد شد، زیرمجموعه شما محسوب می‌شود.", reply_markup=back_menu("account"))
